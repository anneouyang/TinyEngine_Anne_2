...
tinyengine_status convolution_s8_kernel3x3_stride1_pad1x1_input3(q7_t *input, const uint16_t input_x, const uint16_t input_y,
    ...
    for (i_out_y = 0; i_out_y < output_y; i_out_y++) {
		for (i_out_x = 0; i_out_x < output_x; i_out_x++) {
            ...
            if (base_idx_x > input_x - 3){
                ...
                while(cnt--){
                    *dst0++ = pad_out;*dst0++ = pad_out;*dst0++ = pad_out;
                    *dst1++ = pad_out;*dst1++ = pad_out;*dst1++ = pad_out;
                    *dst2++ = pad_out;*dst2++ = pad_out;*dst2++ = pad_out;
                }
            }
