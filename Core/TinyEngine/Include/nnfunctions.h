...
static inline void mac_1row_10col_IOHW_forint8w(q31_t* sum, const q7_t* input_0, 
                      const q7_t* filter_0, const q7_t* filter_1, const q7_t* filter_2, const q7_t* filter_3, const q7_t* filter_4, 
                      const q7_t* filter_5, const q7_t* filter_6, const q7_t* filter_7, const q7_t* filter_8, const q7_t* filter_9) {
...
static inline void mac_1row_10col_IOHW_forint8w_s8_fpreq(q31_t* sum, q15_t* input_0, const q15_t inoff16,
                      const q7_t* filter_0, const q7_t* filter_1, const q7_t* filter_2, const q7_t* filter_3, const q7_t* filter_4, 
                      const q7_t* filter_5, const q7_t* filter_6, const q7_t* filter_7, const q7_t* filter_8, const q7_t* filter_9) {
  *input_0 += inoff16;
  *sum += *input_0++ * *filter_0;
...
static inline void mac_4row_4col_IOHW_forint8w_s8_fpreq(q31_t* sum, const q15_t* four_column_buffer,
                      const q7_t* filter_0, const q7_t* filter_1, const q7_t* filter_2, const q7_t* filter_3) {
  q31_t ch_0_out_0 = 0;
  q31_t ch_1_out_0 = 0;
  q31_t ch_2_out_0 = 0;
  ...
  const q15_t* ip_b0 = four_column_buffer;
  q31_t b0 = arm_nn_read_q15x2_ia(&ip_b0);
  q31_t a01, a02;
  filter_0 = read_and_pad_4weights_reordered(filter_0, filter_1, filter_2, filter_3, &a01, &a02);
  ...
  *sum++ += ch_0_out_0;
  ...
  b0 = arm_nn_read_q15x2_ia(&ip_b0);
  ch_1_out_0 = __SMLAD(a01, b0, ch_1_out_0);
  b0 = arm_nn_read_q15x2_ia(&ip_b0);
  ch_1_out_0 = __SMLAD(a02, b0, ch_1_out_0);
  *sum++ += ch_1_out_0;

  b0 = arm_nn_read_q15x2_ia(&ip_b0);
  ch_2_out_0 = __SMLAD(a01, b0, ch_2_out_0);
  b0 = arm_nn_read_q15x2_ia(&ip_b0);
  ch_2_out_0 = __SMLAD(a02, b0, ch_2_out_0);
  *sum++ += ch_2_out_0;

  b0 = arm_nn_read_q15x2_ia(&ip_b0);
  ch_3_out_0 = __SMLAD(a01, b0, ch_3_out_0);
  b0 = arm_nn_read_q15x2_ia(&ip_b0);
  ch_3_out_0 = __SMLAD(a02, b0, ch_3_out_0);
  *sum++ += ch_3_out_0;
}
...
static inline void mac_1row_4col_IOHW_forint8w_s8_fpreq(q31_t* sum, const q15_t* four_column_buffer,
                      const q7_t* filter_0, const q7_t* filter_1, const q7_t* filter_2, const q7_t* filter_3) {
  q31_t ch_0_out_0 = 0;
...
static inline void assign_sum_to_group_tmp_output_buffer_4row8col_int8(q31_t* out_0, q31_t* out_1, q31_t* out_2, q31_t* out_3, 
  ...
  *out_0++ = sum_0[0];
  *out_max_0 = MAX(abs(*out_max_0), abs(sum_0[0]));
  *out_1++ = sum_0[1];
  *out_max_1 = MAX(abs(*out_max_1), abs(sum_0[1]));
  *out_2++ = sum_0[2];
  *out_max_2 = MAX(abs(*out_max_2), abs(sum_0[2]));
  *out_3++ = sum_0[3];
  *out_max_3 = MAX(abs(*out_max_3), abs(sum_0[3]));
  *out_4++ = sum_0[4];
  *out_max_4 = MAX(abs(*out_max_4), abs(sum_0[4]));
  *out_5++ = sum_0[5];
  *out_max_5 = MAX(abs(*out_max_5), abs(sum_0[5]));
  *out_6++ = sum_0[6];
  *out_max_6 = MAX(abs(*out_max_6), abs(sum_0[6]));
  *out_7++ = sum_0[7];
  *out_max_7 = MAX(abs(*out_max_7), abs(sum_0[7]));

  *out_0++ = sum_1[0];
  *out_max_0 = MAX(abs(*out_max_0), abs(sum_1[0]));
  *out_1++ = sum_1[1];
  *out_max_1 = MAX(abs(*out_max_1), abs(sum_1[1]));
  *out_2++ = sum_1[2];
  *out_max_2 = MAX(abs(*out_max_2), abs(sum_1[2]));
  *out_3++ = sum_1[3];
  *out_max_3 = MAX(abs(*out_max_3), abs(sum_1[3]));
  *out_4++ = sum_1[4];
  *out_max_4 = MAX(abs(*out_max_4), abs(sum_1[4]));
  *out_5++ = sum_1[5];
  *out_max_5 = MAX(abs(*out_max_5), abs(sum_1[5]));
  *out_6++ = sum_1[6];
  *out_max_6 = MAX(abs(*out_max_6), abs(sum_1[6]));
  *out_7++ = sum_1[7];
  *out_max_7 = MAX(abs(*out_max_7), abs(sum_1[7]));

  *out_0++ = sum_2[0];
  *out_max_0 = MAX(abs(*out_max_0), abs(sum_2[0]));
  *out_1++ = sum_2[1];
  *out_max_1 = MAX(abs(*out_max_1), abs(sum_2[1]));
  *out_2++ = sum_2[2];
  *out_max_2 = MAX(abs(*out_max_2), abs(sum_2[2]));
  *out_3++ = sum_2[3];
  *out_max_3 = MAX(abs(*out_max_3), abs(sum_2[3]));
  *out_4++ = sum_2[4];
  *out_max_4 = MAX(abs(*out_max_4), abs(sum_2[4]));
  *out_5++ = sum_2[5];
  *out_max_5 = MAX(abs(*out_max_5), abs(sum_2[5]));
  *out_6++ = sum_2[6];
  *out_max_6 = MAX(abs(*out_max_6), abs(sum_2[6]));
  *out_7++ = sum_2[7];
  *out_max_7 = MAX(abs(*out_max_7), abs(sum_2[7]));

  *out_0++ = sum_3[0];
  *out_max_0 = MAX(abs(*out_max_0), abs(sum_3[0]));
  *out_1++ = sum_3[1];
  *out_max_1 = MAX(abs(*out_max_1), abs(sum_3[1]));
  *out_2++ = sum_3[2];
  *out_max_2 = MAX(abs(*out_max_2), abs(sum_3[2]));
  *out_3++ = sum_3[3];
  *out_max_3 = MAX(abs(*out_max_3), abs(sum_3[3]));
  *out_4++ = sum_3[4];
  *out_max_4 = MAX(abs(*out_max_4), abs(sum_3[4]));
  *out_5++ = sum_3[5];
  *out_max_5 = MAX(abs(*out_max_5), abs(sum_3[5]));
  *out_6++ = sum_3[6];
  *out_max_6 = MAX(abs(*out_max_6), abs(sum_3[6]));
  *out_7++ = sum_3[7];
  *out_max_7 = MAX(abs(*out_max_7), abs(sum_3[7]));
}


static inline void assign_sum_to_group_output_4row8col_int8(q7_t* out_0, q7_t* out_1, q7_t* out_2, q7_t* out_3, q7_t* out_4, q7_t* out_5, q7_t* out_6, q7_t* out_7,
                      const q31_t* sum_0, const q31_t* sum_1, const q31_t* sum_2, const q31_t* sum_3,
                      const q31_t output_activation_min, const q31_t output_activation_max, const float* scales, const float learning_rate, const int i_output_depth) {
...
static inline void assign_sum_to_group_tmp_output_buffer_4row16col_int8(q31_t* out_0, q31_t* out_1, q31_t* out_2, q31_t* out_3, q31_t* out_4, q31_t* out_5, 
  ...
  *out_max_7 = MAX(abs(*out_max_7), abs(sum_0[7]));
  *out_8++ = sum_0[8];
  *out_max_8 = MAX(abs(*out_max_8), abs(sum_0[8]));
  *out_9++ = sum_0[9];
  *out_max_9 = MAX(abs(*out_max_9), abs(sum_0[9]));
  *out_10++ = sum_0[10];
  *out_max_10 = MAX(abs(*out_max_10), abs(sum_0[10]));
  *out_11++ = sum_0[11];
  *out_max_11 = MAX(abs(*out_max_11), abs(sum_0[11]));
  *out_12++ = sum_0[12];
  *out_max_12 = MAX(abs(*out_max_12), abs(sum_0[12]));
  *out_13++ = sum_0[13];
  *out_max_13 = MAX(abs(*out_max_13), abs(sum_0[13]));
  *out_14++ = sum_0[14];
  *out_max_14 = MAX(abs(*out_max_14), abs(sum_0[14]));
  *out_15++ = sum_0[15];
  *out_max_15 = MAX(abs(*out_max_15), abs(sum_0[15]));
  ...
  *out_max_7 = MAX(abs(*out_max_7), abs(sum_1[7]));
  *out_8++ = sum_1[8];
  *out_max_8 = MAX(abs(*out_max_8), abs(sum_1[8]));
  *out_9++ = sum_1[9];
  *out_max_9 = MAX(abs(*out_max_9), abs(sum_1[9]));
  *out_10++ = sum_1[10];
  *out_max_10 = MAX(abs(*out_max_10), abs(sum_1[10]));
  *out_11++ = sum_1[11];
  *out_max_11 = MAX(abs(*out_max_11), abs(sum_1[11]));
  *out_12++ = sum_1[12];
  *out_max_12 = MAX(abs(*out_max_12), abs(sum_1[12]));
  *out_13++ = sum_1[13];
  *out_max_13 = MAX(abs(*out_max_13), abs(sum_1[13]));
  *out_14++ = sum_1[14];
  *out_max_14 = MAX(abs(*out_max_14), abs(sum_1[14]));
  *out_15++ = sum_1[15];
  *out_max_15 = MAX(abs(*out_max_15), abs(sum_1[15]));
  ...
  *out_max_7 = MAX(abs(*out_max_7), abs(sum_2[7]));
  *out_8++ = sum_2[8];
  *out_max_8 = MAX(abs(*out_max_8), abs(sum_2[8]));
  *out_9++ = sum_2[9];
  *out_max_9 = MAX(abs(*out_max_9), abs(sum_2[9]));
  *out_10++ = sum_2[10];
  *out_max_10 = MAX(abs(*out_max_10), abs(sum_2[10]));
  *out_11++ = sum_2[11];
  *out_max_11 = MAX(abs(*out_max_11), abs(sum_2[11]));
  *out_12++ = sum_2[12];
  *out_max_12 = MAX(abs(*out_max_12), abs(sum_2[12]));
  *out_13++ = sum_2[13];
  *out_max_13 = MAX(abs(*out_max_13), abs(sum_2[13]));
  *out_14++ = sum_2[14];
  *out_max_14 = MAX(abs(*out_max_14), abs(sum_2[14]));
  *out_15++ = sum_2[15];
  *out_max_15 = MAX(abs(*out_max_15), abs(sum_2[15]));
  ...
  *out_max_7 = MAX(abs(*out_max_7), abs(sum_3[7]));
  *out_8++ = sum_3[8];
  *out_max_8 = MAX(abs(*out_max_8), abs(sum_3[8]));
  *out_9++ = sum_3[9];
  *out_max_9 = MAX(abs(*out_max_9), abs(sum_3[9]));
  *out_10++ = sum_3[10];
  *out_max_10 = MAX(abs(*out_max_10), abs(sum_3[10]));
  *out_11++ = sum_3[11];
  *out_max_11 = MAX(abs(*out_max_11), abs(sum_3[11]));
  *out_12++ = sum_3[12];
  *out_max_12 = MAX(abs(*out_max_12), abs(sum_3[12]));
  *out_13++ = sum_3[13];
  *out_max_13 = MAX(abs(*out_max_13), abs(sum_3[13]));
  *out_14++ = sum_3[14];
  *out_max_14 = MAX(abs(*out_max_14), abs(sum_3[14]));
  *out_15++ = sum_3[15];
  *out_max_15 = MAX(abs(*out_max_15), abs(sum_3[15]));
}

static inline void assign_sum_to_group_output_4row16col_int8(q7_t* out_0, q7_t* out_1, q7_t* out_2, q7_t* out_3, q7_t* out_4, q7_t* out_5, q7_t* out_6, q7_t* out_7,
                      q7_t* out_8, q7_t* out_9, q7_t* out_10, q7_t* out_11, q7_t* out_12, q7_t* out_13, q7_t* out_14, q7_t* out_15,
                      const q31_t* sum_0, const q31_t* sum_1, const q31_t* sum_2, const q31_t* sum_3,
                      const q31_t output_activation_min, const q31_t output_activation_max, const float* scales, const float learning_rate, const int i_output_depth) {
  *out_0++ -= MIN(MAX(sum_0[0], output_activation_min), output_activation_max) * scales[i_output_depth] * learning_rate;
  *out_1++ -= MIN(MAX(sum_0[1], output_activation_min), output_activation_max) * scales[i_output_depth + 1] * learning_rate;
...
static inline void assign_sum_to_pointwise_output_4row8col_int8(q7_t* out_0, q7_t* out_1, q7_t* out_2, q7_t* out_3, 
    ...
    *out_1++ += (q7_t) MIN(MAX(sum[1], output_activation_min), output_activation_max);
    *out_2++ += (q7_t) MIN(MAX(sum[2], output_activation_min), output_activation_max);
    *out_3++ += (q7_t) MIN(MAX(sum[3], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[4], output_activation_min), output_activation_max);
    *out_1++ += (q7_t) MIN(MAX(sum[5], output_activation_min), output_activation_max);
    *out_2++ += (q7_t) MIN(MAX(sum[6], output_activation_min), output_activation_max);
    *out_3++ += (q7_t) MIN(MAX(sum[7], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[8], output_activation_min), output_activation_max);
    *out_1++ += (q7_t) MIN(MAX(sum[9], output_activation_min), output_activation_max);
    *out_2++ += (q7_t) MIN(MAX(sum[10], output_activation_min), output_activation_max);
    *out_3++ += (q7_t) MIN(MAX(sum[11], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[12], output_activation_min), output_activation_max);
    *out_1++ += (q7_t) MIN(MAX(sum[13], output_activation_min), output_activation_max);
    *out_2++ += (q7_t) MIN(MAX(sum[14], output_activation_min), output_activation_max);
    *out_3++ += (q7_t) MIN(MAX(sum[15], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[16], output_activation_min), output_activation_max);
    *out_1++ += (q7_t) MIN(MAX(sum[17], output_activation_min), output_activation_max);
    *out_2++ += (q7_t) MIN(MAX(sum[18], output_activation_min), output_activation_max);
    *out_3++ += (q7_t) MIN(MAX(sum[19], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[20], output_activation_min), output_activation_max);
    *out_1++ += (q7_t) MIN(MAX(sum[21], output_activation_min), output_activation_max);
    *out_2++ += (q7_t) MIN(MAX(sum[22], output_activation_min), output_activation_max);
    *out_3++ += (q7_t) MIN(MAX(sum[23], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[24], output_activation_min), output_activation_max);
    *out_1++ += (q7_t) MIN(MAX(sum[25], output_activation_min), output_activation_max);
    *out_2++ += (q7_t) MIN(MAX(sum[26], output_activation_min), output_activation_max);
    *out_3++ += (q7_t) MIN(MAX(sum[27], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[28], output_activation_min), output_activation_max);
    *out_1++ += (q7_t) MIN(MAX(sum[29], output_activation_min), output_activation_max);
    *out_2++ += (q7_t) MIN(MAX(sum[30], output_activation_min), output_activation_max);
    *out_3++ += (q7_t) MIN(MAX(sum[31], output_activation_min), output_activation_max);
}

static inline void assign_sum_to_pointwise_output_4row8col_int8_s8_fpreq(q7_t* out_0, q7_t* out_1, q7_t* out_2, q7_t* out_3, const float *scale,
                    q31_t* sum, const q31_t output_activation_min, const q31_t output_activation_max) {
    sum[0] = (q31_t) ((float)sum[0] * scale[0]);
    sum[1] = (q31_t) ((float)sum[1] * scale[1]);
    sum[2] = (q31_t) ((float)sum[2] * scale[2]);
    sum[3] = (q31_t) ((float)sum[3] * scale[3]);
    sum[4] = (q31_t) ((float)sum[4] * scale[4]);
    sum[5] = (q31_t) ((float)sum[5] * scale[5]);
    sum[6] = (q31_t) ((float)sum[6] * scale[6]);
    sum[7] = (q31_t) ((float)sum[7] * scale[7]);
    sum[8] = (q31_t) ((float)sum[8] * scale[8]);
    sum[9] = (q31_t) ((float)sum[9] * scale[9]);
    sum[10] = (q31_t) ((float)sum[10] * scale[10]);
    sum[11] = (q31_t) ((float)sum[11] * scale[11]);
    sum[12] = (q31_t) ((float)sum[12] * scale[12]);
    sum[13] = (q31_t) ((float)sum[13] * scale[13]);
    sum[14] = (q31_t) ((float)sum[14] * scale[14]);
    sum[15] = (q31_t) ((float)sum[15] * scale[15]);
    sum[16] = (q31_t) ((float)sum[16] * scale[16]);
    sum[17] = (q31_t) ((float)sum[17] * scale[17]);
    sum[18] = (q31_t) ((float)sum[18] * scale[18]);
    sum[19] = (q31_t) ((float)sum[19] * scale[19]);
    sum[20] = (q31_t) ((float)sum[20] * scale[20]);
    sum[21] = (q31_t) ((float)sum[21] * scale[21]);
    sum[22] = (q31_t) ((float)sum[22] * scale[22]);
    sum[23] = (q31_t) ((float)sum[23] * scale[23]);
    sum[24] = (q31_t) ((float)sum[24] * scale[24]);
    sum[25] = (q31_t) ((float)sum[25] * scale[25]);
    sum[26] = (q31_t) ((float)sum[26] * scale[26]);
    sum[27] = (q31_t) ((float)sum[27] * scale[27]);
    sum[28] = (q31_t) ((float)sum[28] * scale[28]);
    sum[29] = (q31_t) ((float)sum[29] * scale[29]);
    sum[30] = (q31_t) ((float)sum[30] * scale[30]);
    sum[31] = (q31_t) ((float)sum[31] * scale[31]);
...
static inline void assign_sum_to_pointwise_output_1row8col_int8_norm(q7_t* out_0, 
                      const q31_t* tmp_out, const q31_t output_activation_min, const q31_t output_activation_max, const q31_t out_max) {
    *out_0++ += (q7_t) MIN(MAX((float)tmp_out[0]/out_max*127, output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX((float)tmp_out[1]/out_max*127, output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX((float)tmp_out[2]/out_max*127, output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX((float)tmp_out[3]/out_max*127, output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX((float)tmp_out[4]/out_max*127, output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX((float)tmp_out[5]/out_max*127, output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX((float)tmp_out[6]/out_max*127, output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX((float)tmp_out[7]/out_max*127, output_activation_min), output_activation_max);
}
...
static inline void assign_sum_to_pointwise_output_1row8col_int8(q7_t* out_0, 
                      const q31_t* sum, const q31_t output_activation_min, const q31_t output_activation_max) {
    *out_0++ += (q7_t) MIN(MAX(sum[0], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[1], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[2], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[3], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[4], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[5], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[6], output_activation_min), output_activation_max);
    *out_0++ += (q7_t) MIN(MAX(sum[7], output_activation_min), output_activation_max);
}

static inline void assign_sum_to_pointwise_output_1row8col_int8_s8_fpreq(q7_t* out_0, const float *scale, 
                        q31_t* sum, const q31_t output_activation_min, const q31_t output_activation_max) {
    sum[0] = (q31_t) ((float)sum[0] * scale[0]);
    sum[1] = (q31_t) ((float)sum[1] * scale[1]);
    sum[2] = (q31_t) ((float)sum[2] * scale[2]);
...
static inline void transpose_depthwise_mac_kernel3_2row_uniweight3(q31_t* sum,  
                      const q7_t* two_column_buffer, const q7_t* ksrc_transposed, const uint16_t input_width, 
                      const uint16_t STRIDE, const uint16_t IN_PAD, const uint16_t OUT_PAD) {
...
static inline void transpose_depthwise_mac_kernel3_2row_uniweight2(q31_t* sum_0, q31_t* sum_1, 
                      const q7_t* two_column_buffer, const q7_t* ksrc_transposed, const uint16_t input_width, 
                      const uint16_t STRIDE, const uint16_t IN_PAD, const uint16_t OUT_PAD) {
    // STRIDE = 1; IN_PAD = 1; OUT_PAD = 0;
    *sum_0 += two_column_buffer[0] * ksrc_transposed[0];
    *sum_1 += two_column_buffer[1] * ksrc_transposed[0];
    *sum_0 += two_column_buffer[1] * ksrc_transposed[1];
    *sum_1 += two_column_buffer[2] * ksrc_transposed[1];
    ...
    *sum_1 += two_column_buffer[3] * ksrc_transposed[2];
    // two_column_buffer += (input_width - 1) * STRIDE + 1 + IN_PAD * 2 + OUT_PAD;
    two_column_buffer += (input_width - 1) + 3;
