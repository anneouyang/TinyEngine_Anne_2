/* ----------------------------------------------------------------------
 * Name: transpose_depthwise_conv_fp_kernel3_stride1_inpad1_outpad0_revised.c
...
tinyengine_status_fp transpose_depthwise_conv_fp_kernel3_stride1_inpad1_outpad0_revised_IOHW_int8w_partialCH(float* input_output_data, 
...
tinyengine_status_fp transpose_depthwise_conv_fp_kernel3_stride1_inpad1_outpad0_revised_IOHW_int8w(float* input_output_data, 
                 const uint16_t input_height, const uint16_t input_width, const uint16_t input_depth, 
