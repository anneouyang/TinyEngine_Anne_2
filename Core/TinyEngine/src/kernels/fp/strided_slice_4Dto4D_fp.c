...
//tinyengine_status_fp strided_slice_4Dto4D_fp(const float* input, const uint16_t input_h, const uint16_t input_w, const uint16_t input_c1, const uint16_t input_c2,
