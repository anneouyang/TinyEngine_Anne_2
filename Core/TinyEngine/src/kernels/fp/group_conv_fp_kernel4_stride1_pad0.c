/* ----------------------------------------------------------------------
 * Name: group_conv_fp_kernel4_stride1_pad0.c
...
tinyengine_status_fp group_conv_fp_kernel4_stride1_pad0_in4x4_out1x1_uniweight_4row8col_int8input_inplace(const int8_t* input_data, 
  ...
  for (group = 0; group < groups - 3; group += 4) {
    ...
    while (col_count_div8--) {
      ...
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[0], &sum_1[0], &sum_2[0], &sum_3[0], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[1], &sum_1[1], &sum_2[1], &sum_3[1], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[2], &sum_1[2], &sum_2[2], &sum_3[2], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[3], &sum_1[3], &sum_2[3], &sum_3[3], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[4], &sum_1[4], &sum_2[4], &sum_3[4], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[5], &sum_1[5], &sum_2[5], &sum_3[5], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[6], &sum_1[6], &sum_2[6], &sum_3[6], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[7], &sum_1[7], &sum_2[7], &sum_3[7], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
...
tinyengine_status_fp group_conv_fp_kernel4_stride1_pad0_in4x4_out1x1_uniweight_4row8col_inplace(const float* input_data, 
  ...
  // TODO: For now, we assume leftover_groups is always 3.
  int leftover_groups = groups & 0x3;
  ...
  if (leftover_groups) {
    ...
    while (col_count_div8--) {
      ...
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[0], &sum_1[0], &sum_2[0], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[1], &sum_1[1], &sum_2[1], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[2], &sum_1[2], &sum_2[2], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[3], &sum_1[3], &sum_2[3], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[4], &sum_1[4], &sum_2[4], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[5], &sum_1[5], &sum_2[5], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[6], &sum_1[6], &sum_2[6], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[7], &sum_1[7], &sum_2[7], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
...
tinyengine_status_fp group_conv_fp_kernel4_stride1_pad0_in4x4_out1x1_uniweight_4row8col_inplace_brutal(const float* input_data, 
                 const uint16_t input_height, const uint16_t input_width, const uint16_t input_depth, 
  ...
  for(group = 0; group < groups; group += 4) {
    ...
    while (col_count_div8--) {
      ...
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[0], &sum_1[0], &sum_2[0], &sum_3[0], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[1], &sum_1[1], &sum_2[1], &sum_3[1], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[2], &sum_1[2], &sum_2[2], &sum_3[2], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[3], &sum_1[3], &sum_2[3], &sum_3[3], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[4], &sum_1[4], &sum_2[4], &sum_3[4], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[5], &sum_1[5], &sum_2[5], &sum_3[5], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[6], &sum_1[6], &sum_2[6], &sum_3[6], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[7], &sum_1[7], &sum_2[7], &sum_3[7], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
...
tinyengine_status_fp group_conv_fp_kernel4_stride1_pad0_in4x4_out1x1_uniweight_4row16col_int8input_inplace(const int8_t* input_data, 
  ...
  for (group = 0; group < groups - 3; group += 4) {
    ...
    while (col_count_div16--) {
      ...
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[7], &sum_1[7], &sum_2[7], &sum_3[7], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[8], &sum_1[8], &sum_2[8], &sum_3[8], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[9], &sum_1[9], &sum_2[9], &sum_3[9], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[10], &sum_1[10], &sum_2[10], &sum_3[10], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[11], &sum_1[11], &sum_2[11], &sum_3[11], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[12], &sum_1[12], &sum_2[12], &sum_3[12], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[13], &sum_1[13], &sum_2[13], &sum_3[13], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[14], &sum_1[14], &sum_2[14], &sum_3[14], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_4row_16col_fp_uniweight_IOHW(&sum_0[15], &sum_1[15], &sum_2[15], &sum_3[15], input_0, input_1, input_2, input_3, filter, output_depth_per_group);
      filter++;
...
tinyengine_status_fp group_conv_fp_kernel4_stride1_pad0_in4x4_out1x1_uniweight_4row16col_inplace(const float* input_data, 
  ...
  if (leftover_groups) {
    ...
    while (col_count_div16--) {
      ...
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[7], &sum_1[7], &sum_2[7], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[8], &sum_1[8], &sum_2[8], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[9], &sum_1[9], &sum_2[9], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[10], &sum_1[10], &sum_2[10], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[11], &sum_1[11], &sum_2[11], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[12], &sum_1[12], &sum_2[12], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[13], &sum_1[13], &sum_2[13], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[14], &sum_1[14], &sum_2[14], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_3row_16col_fp_uniweight_IOHW(&sum_0[15], &sum_1[15], &sum_2[15], input_0, input_1, input_2, filter, output_depth_per_group);
      filter++;
...
tinyengine_status_fp group_conv_fp_kernel4_stride1_pad0_in4x4_out1x1_uniweight_4row16col_inplace_brutal(const float* input_data, 
                 const uint16_t input_height, const uint16_t input_width, const uint16_t input_depth, 
                 float* filter_data, const float* bias_data, 
                 int8_t* output_weight_data, const uint16_t output_height, const uint16_t output_width, const uint16_t output_depth, 
                 const float output_activation_min, const float output_activation_max,
  ...
  for(group = 0; group < groups; group += 4) {
    ...
    while (col_count_div16--) {
      ...
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[7], &sum_1[7], &sum_2[7], &sum_3[7], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[8], &sum_1[8], &sum_2[8], &sum_3[8], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[9], &sum_1[9], &sum_2[9], &sum_3[9], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[10], &sum_1[10], &sum_2[10], &sum_3[10], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[11], &sum_1[11], &sum_2[11], &sum_3[11], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[12], &sum_1[12], &sum_2[12], &sum_3[12], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[13], &sum_1[13], &sum_2[13], &sum_3[13], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[14], &sum_1[14], &sum_2[14], &sum_3[14], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_4row_16col_fp_uniweight(&sum_0[15], &sum_1[15], &sum_2[15], &sum_3[15], input_0, input_1, input_2, input_3, filter);
      filter += DIM_KER_X * DIM_KER_Y;
...
tinyengine_status_fp group_conv_fp_kernel4_stride1_pad0_in4x4_out1x1_uniweight_2row32col_int8input_inplace(const int8_t* input_data, 
  ...
  for (group = 0; group < groups - 1; group += 2) {
    ...
    while (col_count_div32--) {
      ...
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[0], &sum_1[0], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[1], &sum_1[1], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[2], &sum_1[2], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[3], &sum_1[3], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[4], &sum_1[4], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[5], &sum_1[5], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[6], &sum_1[6], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[7], &sum_1[7], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[8], &sum_1[8], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[9], &sum_1[9], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[10], &sum_1[10], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[11], &sum_1[11], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[12], &sum_1[12], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[13], &sum_1[13], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[14], &sum_1[14], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[15], &sum_1[15], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[16], &sum_1[16], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[17], &sum_1[17], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[18], &sum_1[18], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[19], &sum_1[19], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[20], &sum_1[20], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[21], &sum_1[21], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[22], &sum_1[22], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[23], &sum_1[23], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[24], &sum_1[24], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[25], &sum_1[25], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[26], &sum_1[26], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[27], &sum_1[27], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[28], &sum_1[28], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[29], &sum_1[29], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[30], &sum_1[30], input_0, input_1, filter, output_depth_per_group);
      filter++;
      group_mac_kernel4_2row_32col_fp_uniweight_IOHW(&sum_0[31], &sum_1[31], input_0, input_1, filter, output_depth_per_group);
      filter++;
...
tinyengine_status_fp group_conv_fp_kernel4_stride1_pad0_in4x4_out1x1_uniweight_2row32col_inplace_brutal(const float* input_data, 
                 const uint16_t input_height, const uint16_t input_width, const uint16_t input_depth, 
                 float* filter_data, const float* bias_data, 
                 int8_t* output_weight_data, const uint16_t output_height, const uint16_t output_width, const uint16_t output_depth, 
                 const float output_activation_min, const float output_activation_max,
  ...
  for(group = 0; group < groups; group += 2) {
    ...
    while (col_count_div32--) {
      ...
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[0], &sum_1[0], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[1], &sum_1[1], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[2], &sum_1[2], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[3], &sum_1[3], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[4], &sum_1[4], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[5], &sum_1[5], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[6], &sum_1[6], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[7], &sum_1[7], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[8], &sum_1[8], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[9], &sum_1[9], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[10], &sum_1[10], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[11], &sum_1[11], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[12], &sum_1[12], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[13], &sum_1[13], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[14], &sum_1[14], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[15], &sum_1[15], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[16], &sum_1[16], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[17], &sum_1[17], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[18], &sum_1[18], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[19], &sum_1[19], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[20], &sum_1[20], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[21], &sum_1[21], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[22], &sum_1[22], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[23], &sum_1[23], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[24], &sum_1[24], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[25], &sum_1[25], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[26], &sum_1[26], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[27], &sum_1[27], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[28], &sum_1[28], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[29], &sum_1[29], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[30], &sum_1[30], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
      group_mac_kernel4_2row_32col_fp_uniweight(&sum_0[31], &sum_1[31], input_0, input_1, filter);
      filter += DIM_KER_X * DIM_KER_Y;
