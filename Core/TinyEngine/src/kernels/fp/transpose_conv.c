            ...
            for (int filter_x = 0; filter_x < filter_width; ++filter_x) {
              for (int out_channel = 0; out_channel < output_depth; ++out_channel) {
                ...
                if ((out_x >= 0) && (out_x < output_width) && (out_y >= 0) && (out_y < output_height)) {
                  float input_value = input_data[Offset(input_height, input_width, input_depth, batch, in_y, in_x, in_channel)];
                  float filter_value = filter_data[Offset(filter_height, filter_width, input_depth, out_channel, filter_y, filter_x, in_channel)];

                  output_data[Offset(output_height, output_width, output_depth, batch, out_y, out_x, out_channel)] += input_value * filter_value;
                }
              }
            }
          }
              ...
              for (int out_channel = 0; out_channel < output_depth;
                ...
                if ((out_x >= 0) && (out_x < output_width) && (out_y >= 0) &&
                  ...
                  float input_value = input_data[Offset(
                      input_height, input_width, input_depth, batch, in_y, in_x, in_channel)];
//                  float filter_value =
//                      filter_data[Offset(filter_height, filter_width, input_depth, out_channel, filter_y,
//                                         filter_x, in_channel)];
                  float filter_value =
                                        filter_data[Offset(filter_height, filter_width, output_depth, in_channel, filter_y,
                                                           filter_x, out_channel)];
                  output_data[Offset(output_height, output_width, output_depth, batch, out_y, out_x,
                                     out_channel)] +=
            ...
            for (int filter_x = 0; filter_x < filter_width; ++filter_x) {
              for (int out_channel = 0; out_channel < output_depth;
                ...
                if ((out_x >= 0) && (out_x < output_width) && (out_y >= 0) &&
                  ...
                  int8_t filter_value_int8;
                  int weight_offset;
                  if (out_channel < first_k_channel){
                	  weight_offset = Offset(filter_height, filter_width, first_k_channel, in_channel, filter_y, filter_x, out_channel);
                	  filter_value_int8 = filter_sram[weight_offset];
                  }
				  else{
                	  weight_offset = Offset(filter_height, filter_width, output_depth - first_k_channel, in_channel, filter_y, filter_x, out_channel - first_k_channel);
