/* ----------------------------------------------------------------------
 * Name: transpose_conv_fp_kernel7_stride1_inpad3_outpad0.c
    ...
    for (int i_in_x = 0; i_in_x < input_width - 1; i_in_x+=2) {
      ...
      while (row_count--) {
        ...
        while (input_depth_div4--) {
          ...
          out6 = out6_start;
          out7 = out7_start;
          transpose_mac_7row_7col_2input_2filter_1stride_fp(out, out2, out3, out4, out5, out6, out7, output_depth, input_0, input_1, filter_0, filter_1);
          input_0++; input_1++;
      ...
      if (output_depth & 0x1) {
        ...
        while (input_depth_div4--) {
          ...
          out6 = out6_start;
          out7 = out7_start;
          transpose_mac_7row_7col_2input_1filter_1stride_fp(out, out2, out3, out4, out5, out6, out7, output_depth, input_0, input_1, filter_0);
          input_0++; input_1++;
          filter_0 += DIM_KER_X * DIM_KER_Y;
