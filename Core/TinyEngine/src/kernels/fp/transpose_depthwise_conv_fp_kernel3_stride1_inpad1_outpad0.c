/* ----------------------------------------------------------------------
 * Name: transpose_depthwise_conv_fp_kernel3_stride1_inpad1_outpad0.c
  ...
  for (c = 0; c < input_depth; c++) {
    ...
    for (i = 0; i < input_height; i++) {
      for (j = 0; j < input_width - 1; j+=2) {
        ...
        transpose_mac_3row_3col_2input_1filter_1stride_fp(out, out2, out3, output_depth, input_0, input_1, ksrc);
      ...
      if (input_width & 0x1) {
        ...
        transpose_mac_3row_3col_1input_1filter_xstride_fp(out, out2, out3, output_depth, input_0, ksrc);
