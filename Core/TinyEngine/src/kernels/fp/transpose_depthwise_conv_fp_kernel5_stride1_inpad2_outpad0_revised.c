/* ----------------------------------------------------------------------
 * Name: transpose_depthwise_conv_fp_kernel5_stride1_inpad2_outpad0_revised.c
...
tinyengine_status_fp transpose_depthwise_conv_fp_kernel5_stride1_inpad2_outpad0_revised_IOHW_int8w_partialCH(float* input_output_data, 
...
tinyengine_status_fp transpose_depthwise_conv_fp_kernel5_stride1_inpad2_outpad0_revised_IOHW_int8w(float* input_output_data, 
                 const uint16_t input_height, const uint16_t input_width, const uint16_t input_depth, 
  ...
  for (c = 0; c < input_depth; c++) {
    ...
    for (i = 0; i < output_height; i++) {
      for (j = 0; j < output_width - 1; j+=2) {
        ...
        two_column_buffer += input_width + 4;
