/* ----------------------------------------------------------------------
 * Name: transpose_depthwise_conv_kernel3_stride2_inpad1_outpad1_revised.c
...
tinyengine_status transpose_depthwise_conv_kernel3_stride2_inpad1_outpad1_revised_IOHW_partialCH(int8_t* input_data, 
  ...
  for (c = 0; c < input_depth; c++) {
    two_column_buffer = im2col_data + input_width * 2 + 2;
    src = input_data;
    ...
    for (i = 0; i < input_height; i++) {
      ...
      two_column_buffer += input_width * 2 + 3;
    }
